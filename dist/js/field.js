...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.watchedComponents.forEach(function (component) {
      ...
      if (component.field.component === 'morph-to-field') {
        ...
        // also watch morph-type
        component.$watch('resourceType', function (value) {
          _this.morphType = value;
  ...
  computed: {
    ...
    endpoint: function endpoint() {
      return this.field.endpoint.replace('{morph-type}', this.morphType).replace('{resource-name}', this.resourceName).replace('{resource-id}', this.resourceId ? this.resourceId : '').replace('{' + this.field.parent_attribute + '}', this.parentValue ? this.parentValue : '');
    },
